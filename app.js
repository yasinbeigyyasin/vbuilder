...
const PRESETS = {
  desktop: { label: "Desktop", width: 1440, height: 900, media: null },
...
function renderCanvas() {
  ...
  refs.canvasCaption.textContent = `${preset.label} · ${preset.width} × ${preset.height}`;
...
function generateCss() {
  ...
  const desktop = PRESETS.desktop;
  const lines = [
    "/* Generated by VBuilder — edit the canvas, then export again. */",
